                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="item-list.html"><span class="item-text">ITEM LIST</span></a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="personal-info-container">
                                <div id="edit-acc-popup-lightbox" class="">
                                    <h5>EDIT PROFILE</h5>
                                    <div class="con-info">
                                        <style>
                                            .inputbox input{
                                    ...
                                    <div class="inputbox">
                                        <center><input type="text" id="email" name="per_email" value="<?php echo $row['email'] ?>" required=""></center>
                                    </div>
                                    <div class="inputbox">
                                        <center><input type="text" id="phone" name="per_phone" value="<?php echo $row['phone'] ?>" required=""></center>
                                    </div>
                                    <div class="inputbox">
                                        <center><input type="text" id="address" name="per_address" value="<?php echo $row['address'] ?>" required=""></center>
                                    </div>
                                    <div class="inputbox">
                                        <center><input type="text" id="pass" name="per_pass" value="<?php echo $row['pass'] ?>" required=""></center>
                                    </div>
                                    <div class="inputimg">
                                        <center><input type="file" name="image"  id="upload-img" accept="image/*" value="<?php echo $row['img'] ?>" required=""></center>
                                    </div>
