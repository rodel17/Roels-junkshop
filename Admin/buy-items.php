...
<head>
	...
	<title>Roel's Junk Shop - Items</title>
...
<body>
	...
	<div class="sidebar-menu">
		<ul>
			...
			<li>
				<a href="buy-items.php" class="active"><span class="fas fa-shopping-bag"></span>
	...
	<style type="text/css">
		...
		<main>
			<div class="search-area">
				<a href="add-item.php" class=""><span class="fas fa-plus"></span> ADD ITEM</a>
			</div>
			<div class="customers-grid">
				<div class="customers-items">
					<div class="customers-card">
						<div class="customers-card-header">
							<h2>Items (On Website)</h2>
						</div>
									...
									if (isset($_SESSION['unique_id'])) {
										...
										if (mysqli_num_rows($query) > 0) {
											while ($row = mysqli_fetch_assoc($query)) {
												if ($row['item_status'] === 'buy') {
												?>
												<a href="view-item.php?item_id=<?php echo $row['item_id'] ?>">
												<table width="100%">
													<tbody>
														<tr>
