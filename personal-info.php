            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="personal-info-container">
                            ...
                            <center><div class="personal-img">
                                <img src="php/images/<?php echo $row['img'] ?>" alt="">
                                <h5><?php echo strtoupper($row['fname']) . " " . strtoupper($row['lname']) ?></h5>
                                <a class="btn btn-danger btn-sm" href="update-profile.php">Edit Profile</a>

                            </div></center>
                            <div class="personal-information">
                                <div class="info" id="user-email">
                                    <h4 class="e-add">Email Address:</h4>
                                    <p><?php echo ($row['email']) ?></p>

                                </div>
                                <div class="info" id="user-pnum">
                                    <h4 class="p-num">Phone no:</h4>
                                    <p><?php echo $row['phone'] ?></p>

                                     
                                </div>
                                <div class="info" id="user-address">
                                    <h4 class="add">Address:</h4>
                                    <p><?php echo $row['address'] ?></p>

                                     
                                </div>
                                <div class="info" id="user-password">
                                    <h4 class="passw">Password:</h4>
                                    <p><?php echo str_repeat("*", strlen($row['pass'])) ?></p>

                                     
                                </div>
                                <div class="info" id="delete-account">
                                    <h4>Delete Account</h4><a class="remove-account popup-with-move-anim" id="rev-account" href="#delete-account-popup-lightbox"><i class="fas fa-arrow-right"></i></a>
                                    <p>Delete your Account?</p>

                                     <div id="delete-account-popup-lightbox" class="lightbox-pop zoom-anim-dialog mfp-hide">
                                        <center><h4>DELETE ACCOUNT</h4></center>
                                        <center><h5>Are you sure you want to delete this account?</h5></center>
                                        <center><p style="color: #fa6161;"><b>Warning: Your account and information will permanently deleted! Do you still wish to continue?</b></p></center>
                                        ...
                                        <center><a href="delete-acc.php?unique_id=<?php $row['unique_id'];?>" class="" id="delete">Delete</a><button class="btn-close" aria-label="Close" type="button" id="Close">Cancel</button></center>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="index.html">Home</a><i class="fa fa-angle-double-right"></i><span>Roel's Web Based Junk Shop: Personal Information</span>
